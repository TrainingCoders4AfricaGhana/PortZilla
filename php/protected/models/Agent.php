...
class Agent extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'shipments' => array(self::HAS_MANY, 'Shipment', 'agent_id'),
        );
    }
    ...
    //returns all of the Agents values in a list format
    public function getAllAgents() {
        return CHtml::listData(Agent::model()->findAll(), 'id', 'first_name', 'last_name');
    }
}